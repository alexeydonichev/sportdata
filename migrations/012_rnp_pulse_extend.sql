...
-- ============================================
-- 2. Добавляем created_at если нет
-- ============================================

ALTER TABLE rnp_items ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW();

-- ============================================
-- 3. Расширяем rnp_items
-- ============================================
...
-- ============================================
-- 8. Триггер: авто-расчёт reviews_ok
-- ============================================
...
-- ============================================
-- 9. Триггер: авто-расчёт needs_attention
-- ============================================
...
-- ============================================
-- 10. VIEW: Сводка для UI
-- ============================================

DROP VIEW IF EXISTS rnp_items_summary;

CREATE VIEW rnp_items_summary AS
SELECT 
    i.id,
    i.template_id,
    i.name,
...
-- ============================================
-- 11. Обновляем существующие данные
-- ============================================
